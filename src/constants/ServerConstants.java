...
public class ServerConstants {
    ...
    public static final byte MIN_RANGELEVEL_TO_EXP_LEECH = 20;          //Characters are unable to leech EXP from party member kills whose level difference are past this limit.
    ...
    public static final int WEDDING_RESERVATION_INTERVAL = 20;  //Time between wedding starts in minutes.
