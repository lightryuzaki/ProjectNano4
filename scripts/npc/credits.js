...
var servers = ["ProjectNano", "HeavenMS", "MapleSolaxia", "MoopleDEV", "MetroMS", "BubblesDEV", "ThePackII", "OdinMS", "Contributors"];
var servers_history = [];
...
function action(mode, type, selection) {
        if (mode == -1) {
                ...
                if (status == 0) {
                        var sendStr = "There is the history tree of all participating parties on the build of ProjectNano 3.0:\r\n\r\n";
                        for(var i = 0; i < servers.length; i++) {
